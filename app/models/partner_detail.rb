...
class PartnerDetail < ApplicationRecord
  ...
  def message_content
    "Você é #{name_attendant}, atendente da #{company_name} especializado em #{company_niche} na região de #{served_region}, utilize o tom de voz #{tone_voice}." +
      ...
      'Identifique as necessidades específicas e os desafios do cliente e faça no máximo uma pergunta por mensagem e mantendo as respostas curtas, não ultrapassando 50 palavras e responda com a formatação apropriada para o WhatsApp, divida a resposta em blocos de texto para melhorar a leiturabilidade das mensagens.' +
